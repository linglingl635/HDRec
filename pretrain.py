...
from utils.utils import ExpDataLoader, SeqDataLoader, AllBatchify, ExpBatchify, SeqBatchify, TopNBatchify, now_time, RSBatchify
...
parser.add_argument('--lr', type=float, default=0.0005,
                    help='learning rate')
parser.add_argument('--ratio', type=str, default='1:1:1:3',  # ratio: groundtruth:sequential:review summary:topn
...
rs_iterator = RSBatchify(exp_corpus.valid, tokenizer, args.exp_len * 2, args.batch_size)
...
for epoch in range(1, args.epochs + 1):
    ...
    rs_loss = evaluate(rs_iterator)
    print(now_time() + 'review summary loss {:4.4f}'.format(rs_loss))
    ...
    val_loss = (exp_loss + rs_loss + seq_loss + topn_loss) / 4
